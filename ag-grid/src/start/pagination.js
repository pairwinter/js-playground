        ...
        function setRowData(allOfTheData) {
            ...
            var dataSource = {
                ...
                getRows: function (params) {
                    console.log('gridOptions.api.paginationGetPageSize:', gridOptions.api.paginationGetPageSize());
                    var pagination = {
                        pageNo: params.startRow === 0 ? 1 : params.startRow / gridOptions.api.paginationGetPageSize(),
                        pageSize: gridOptions.api.paginationGetPageSize()
                    };
                    console.log('pagination:', pagination);

                    console.log('params', JSON.stringify(params));
                    console.log('filterModel', JSON.stringify(params.filterModel));//{"athlete":{"type":"contains","filter":"Mich","filterType":"text"}}
                    console.log('sortModel', JSON.stringify(params.sortModel));//[{"colId":"athlete","sort":"asc"}]
